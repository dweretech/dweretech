...
<meta name="keywords" content="My Africa Vision 2020, NGOs, promote Trade, Tourism, Development, 
		  ...
		  Dwere herbal Research and Youth Foundation, Africa, African Community, Africa USA, Uganda" name="home" >
...
MM_showHideLayers('LoginForm','','show');

;" >
<table width="932" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#000000" bgcolor="#FCFCC4" >
  <tr bgcolor="#C4B484">
    <td width="224" height="23" bordercolor="#FCFCC4" bgcolor="#FCFCC4" class="AVMenu"  ><p align="center"><a href="index.php"    target="_self" id="home">Home</a> | <a href="#" id="aboutus" onClick="getText('AVCenterStage','about.php;')"> About us</a> | <a href="#" id="v2020" onClick="MM_showHideLayers('LoginForm','','show')" >Sign-On</a> <br>
    </td>
 ...
 ?>
  ...
  <tr>
    ...
    <td width="441" rowspan="5" valign="top" bordercolor="#C4B484" bgcolor="#C4B484" class="AVbodyText" id="AVbodyHeader"  ><span class="AVbodyText style12"><span class="style22">Welcome!</span> My  place for Real-Time Resources. <strong></strong><strong>Know all about =&gt; | Trade | Tourism | Development | Health Care | Technology Exploration | Minerals | Food | Agriculture | Micro Loan Financing | Infrastructure planning |</strong><span class="style22"> <a href="#" onClick="doControlPanel('Uganda','iCard')">eAfrica </a></span></span> <hr><span class="style11 AVbodyText" id="AVCenterStage" ><img src="images/AFRICA_MAP.gif" width="440" height="440" border="0" usemap="#Map"   id="AVMap" class="AVMapShow"  >
      ...
      <hr>
        <p class="AVbodyText"  >The standards of the world  communities are changing by the hour and we are working to bring you aboard.  Stability in across Africa is eminent and that is an opportunity as members to  take part in your areas of interest. [<a href="#" onClick="MM_showHideLayers('formAVJoinUs','','show');getMainContentStatus('formAVJoinUs','newuser.php');clearForm(document.formjoinAVNet);getText('AVCenterStage','avmap.txt')">more..</a>.]</p></td>
    <td width="233" rowspan="3"  align="center" bordercolor="#C4B484" bgcolor="#C4B484" class="ShowMe"><p><span class="ShowMe" id="AVAdvertiseBoard"></span> <a href="#" 
    onClick="MM_showHideLayers('AVMap','','hide');MM_showHideLayers('AVMapH','','hide');MM_showHideLayers('AVMapS','','show')"  id="AVMapH">Hide Map >></a> <a href="#"  onClick="getText('formAVJoinUs','community.txt')">More...</a><a href="#"    onClick="MM_showHideLayers('AVMap','','show');MM_showHideLayers('AVMapH','','show');MM_showHideLayers('AVMapS','','hide')" id="AVMapS"><&lt;Show Map</a></p>
    <p></span> <a href="#" onClick="getText('AVCenterStage','videos.php')">Evolving Cities</a> |<a href="#" id="career" onClick="getText('AVCenterStage','jobs.php')"> Jobs</a></p></td>
  ...
  <tr>
    <td height="26" valign="top" bordercolor="#FCFCC4" bgcolor="#FCFCC4"><div align="center"><span class="AVMenu" id="AVControlPanelOptions"></span> <a href="#" onClick="getText('AVCenterStage','videos.php')">Evolving Cities</a> <span class="AVMenu">(video)</span></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="345"  align="left" class="style21"><p>We are working under a simple premise, how do we answer these 5 big African questions?</p>
      ...
      <p>These 5 big questions seek  answers from YOU.  Roles being played by others like you could be a preparation for future  leadership in Africa vision 2020. It is important therefore to think through these  questions as you browse through this web site. If you can answer all five questions confidently, you are an important  board <a href="index.php">member</a> of Vision 2020 group. <br>
        Today others have engaged in pursuing  practical goals which to shape the future for generations to come. What  is your role? As member there is project vision 2020 across the continent. From here, you get guidance  to a point of contact in Kenya, Ghana, South Africa, or any place of your choice to be commissioned for Vision 2020 projects. </p>
      <p>We are a purpose driven group. Please stay tuned! </p>
      <p>Please  click <a href="#" onClick="MM_showHideLayers('formAVJoinUs','','show');getMainContentStatus('formAVJoinUs','newuser.php');clearForm(document.formjoinAVNet);clearForm(document.formUserAuth)"> eAfrica Vision 2020</a></span> to sign our guest book.</p></td>
  </tr>
</table>
 
    </div></td>
    <td valign="top" bordercolor="#C4B484" bgcolor="#C4B484"><div id="formAVLogin"  class="AVForms">
      <form action="authenticate.php" method="post" name="formUserAuth" class="AVMenu" id="LoginForm"  >
        <table>
          <tr>
            <td> Username:</td>
