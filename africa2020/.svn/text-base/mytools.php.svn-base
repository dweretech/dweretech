...
$web_upload_dir = "upload"; // Directory for file storing
                          // Web-Server dir 
...
<p><a href="{$filename}" style="font-size: large;">download file</a><br>
...
<br><br>Example by <a href="mytools.php/">My Web Tools</a>
</body></html>
END;
    // save HTML 
