...
list($myname,$mystate,$myemail,$myuname,$myupass,$about) = split(';',$UserInfo);
...
<table width="958" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#C4B484">
  <tr bgcolor="#C4B484" >
    <td height="10" bgcolor="#FCFCC4" class="AVMenu"><!--| <a href="#" target="_self" onClick="getText('AVbodyV',document.AVFormContent.file.value='home')">Home</a> <a href="#" onClick="getText('AVbodyV',document.AVFormContent.file.value='about')">About us</a> //-->      <a href="#" target="_self" onClick="getText('AVbodyV',document.AVFormContent.file.value='community')">My Community</a> | <a href="#" onClick="getText('AVbodyV',document.AVFormContent.file.value='trading')">Trading: $1</a> | <a href="logout.php" target="_self"  onClick="logout()">Log out</a></div></td>
    ...
    <br><a href="http://www.dvlottery.state.gov" target="_blank" class="AVMenu style18">US Visa Lottery 2011</a></span>
    <table align="right">
    </table>
    <div align="right"></div>    <div align="right"></div></td>
  </tr>
  <tr bgcolor="#FFCC00">
    <td height="21" bgcolor="#FCFCC4" class="AVMenu"><a href="#"  onClick="getProfileText('<?=$challenge?>')">You are:
          <?=$myname?>
    </a>      <div align="center"></td>
    <td width="440" rowspan="5" valign="top" bgcolor="#C4B484" class="ShowMe"> <div align="left"><strong><img src="images/mpoll.gif" alt="My Picture" name="mypicture" width="10" height="50" hspace="2" vspace="0" border="0" align="left"><span class="AVbodyText style19">Welcome!</span> <span class="AVbodyText"><strong>My  place for Real-Time Resources. Know all about =&gt; | Trade | Tourism | Development | Health Care | Technology Exploration | Minerals | Food | Agriculture | Micro Loan Financing | Infrastructure planning |</strong> <span class="style19"><em><a href="#" onClick="getText('AVbodyV','Africa')">eAfrica</a></em> </span></span></strong> </div>  <hr>
      ...
      <map name="Map">
        ...
        <area shape="poly" coords="73,75,142,125,168,106,184,99,182,93,171,84,172,76,171,59,160,37,166,24,152,22,135,23,124,26,113,32,114,49,100,51,88,61,76,67" href="#" onClick="MM_callJS('Algeria')">
      ...
      <span id="AFVNotes"></span></td>
  </tr>
  <tr valign="top">
    <td height="20" bgcolor="#FCFCC4">
      <form name="formSearch" method="post" action="#" target="_self" onClick="getText('AVbodyV',document.formSearch.txtSearch.value);">
        <input name="button" type="button" class="AVMenu" id="button2"   value="Search"  onClick="getText('AVbodyV',document.formSearch.txtSearch.value);">
        <input type="text" name="txtSearch" id="txtSearch2" value="<?=$mystate?>"  onClick="MM_showHideLayers('AVSrch','','show')">
        <br>
  ...
  <tr valign="top">
    <td rowspan="6" valign="top" bgcolor="#FCFCC4">
    ...
    <td width="160" height="21" align="center" valign="top" bgcolor="#C4B484" >    
      <div align="left" class="AVForms2">
        <div align="left"><span class="AVHeaders" style="azimuth:center">To-Do</span><span class="Style21"><br>
            <a href="#" 
    onClick="getNotes('AVCenterStage','notes.php;<?=$UserInfo?>')"  id="AVMapH">Notes </a> | <a href="#" onClick="getNotes('AVCenterStage','album.php;<?=$UserInfo?>')">Album</a> <br>
          <span class="style19 style19"><a href="#"  onFocus="getText('AVCenterStage','notes.php;<?=$UserInfo?>')" onClick="DoNotes('AVCenterStage;list')">myProjects</a></span></span> <span class="AVMenu style18 style19 style19">
          in 
          <?=$mystate?>
          </span></div>
      </div>
  ...
  <tr>
    ...
    <td height="400" valign="top" bgcolor="#C4B484" class="AVForms"> 
      ...
      <ul>
                <li><a href="#" onClick="getText('AVCenterStage','jobs.php;')">IT Jobs</a></li>
        <li>Web job.</li>
