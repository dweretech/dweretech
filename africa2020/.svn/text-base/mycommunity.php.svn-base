...
//echo '<br>Challenging ...'.$challenge.' my name '.$myname.' my state '.$mystate.' my host '.$hostname;
...
function UpdateProfile(ssndata){
// dummy function to reset session
    alert(ssndata);
	...
	xmlHttp.open('GET','joinunion.php?name=',true);
...
.AVbodyText {	font-family: Arial, Helvetica, sans-serif;
	font-size: 12px;
}
.AVForms2 {	font-size: 11px;	
...
<table width="978" border="0" align="center">
  <tr>
    <td height="10" colspan="2"> <span class="AVForms"><a href="index.php" target="_self">Home</a> | <a href="#">About us</a> | <a href="#">Vision2020</a> | <a href="#">Trading: $1</a></span><br></td>
    <td width="315"><div align="center"><span class="AVHeaders">Africa Vision 2020 </span></div></td>
    <td width="207" rowspan="2"><span class="AVForms">There are <font color="#FF3300">
    <?=$UsersOnLine?>
...
<?php $todayis = date("F j, Y, g:i a");
 ...
 ?>
  ...
  <tr>
    <td width="266" height="21"><a href="#" class="AVForms" onClick="return MM_showHideLayers('formAVJoinUs','','show')">You are:
        <?=$myname?>
    </a></td>
    <td width="172"><div align="center"><a href="logout.php" target="_self" class="AVForms" onClick="logout()">Log out</a></div></td>
    <td width="315">&nbsp;</td>
  </tr>
  <tr>
    <td height="40" colspan="2">
      <form name="formSearch" method="post" action="search.php"  target="_self">
        ...
        <input name="button" type="submit" class="AVForms" id="button" onClick="return javascript:document.formSearch.submit()" value="Search">
        <input type="text" name="txtSearch" id="mySearch" value="<?=$mystate?>">
      </form>    </td>
    <td width="315" class="AVbodyText">The future of Africa lies in our hand. We must get involve in order to bring a solution.   
      <?=$myname?>! are you ready?</td>
    <td width="207" class="AVForms">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2" valign="top"><div id="AVbodyV" class="AVForms"   >My Community Page</div>
      <img src="images/AFRICA_MAP.gif" width="440" height="440" border="0" usemap="#Map"  onClick="">
      <map name="Map">
        ...
        <area shape="poly" coords="-126,197,-118,198,-110,204,-102,206,-93,204,-83,200,-70,195,-67,190,-61,183,-59,179,-66,179,-78,175,-82,171,-86,166,-84,162,-90,164,-93,160,-93,157,-93,153,-99,146,-106,143,-113,145,-118,147,-123,149,-128,156,-131,161,-135,167,-136,173,-139,178,-142,179,-133,189" href="#" onClick="MM_callJS('Ethiopia')">
...
<form name="form1" method="post" action="" onClick="alert(document.form1.txtMyAfrica.value)">
	...
	style="background-color:#00FF00;text-align:center;background-attachment:fixed; font-size:24px"  onKeyPress="return taLimit(this)" onKeyUp="return taCount(this,'myCounter')" ></textarea>
    <input name="Submit" type="submit" class="HideMe" value="Submit">

</form>  
</div>
<H1 ALIGN=center><span class="AVForms2">Copyright &copy; 1999 &mdash; 2008 Africa Vision 2020. All   rights reserved. <BR>
All logos and trademarks are properties of their respective   companies. Product price, specification, warranty and availability subject to   change without notice.</span></H1>
</body>
</html>
