...
<body  class="AVBody" onLoad="MM_showHideLayers('AVMapS','','hide');getMainContentStatus('community');MM_showHideLayers('formAVJoinUs','','show')">

<table width="932" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
    <td width="230" height="23" bgcolor="#FFCC00" class="AVMenu"  >
      <p><a href="index.php" target="_self" id="home">Home</a> | <a href="#" id="aboutus">About us</a> | <a href="#" id="v2020" onClick="MM_showHideLayers('LoginForm','','show')">Sign-On</a> <br>
    </td>
    <td width="440" valign="top" bgcolor="#FFCC00"><div align="center"><span class="AVHeaders"> Africa Vision 2020 </span></div></td>
    <td width="258" bgcolor="#FFCC00"><span class="ShowMe">Date:
 ...
 ?>
  ...
  <tr>
    ...
    <td width="440" rowspan="2" valign="top" bgcolor="#FFCC00" class="AVbodyText" id="AVbodyV"  ><span class="AVbodyText style12">Welcome! The place for real-time resource. Know about Trade, Tourism, Development, Healthe Care, Technology Exploration, Mineral Resources, Food and Agriculture, Micro Loan Financing and Infrastructure planning in Africa.</span> </td>
    <td width="258" rowspan="2" bgcolor="#FFCC00" class="ShowMe">
    
    <td rowspan="2" class="ShowMe">&nbsp;</td>
  </tr>
  <tr bgcolor="#FFCC00">
    <td valign="top"><input name="button" type="submit" class="AVMenu" id="button"  value="Where am I ?" >
      <input name="txtSearch" type="text" id="mySearch"  
          onChange="getText(document.formSearch.txtSearch.value);" 
          onClick="MM_showHideLayers('AVSrch','','show');" 
          value="--- Click  Map below ---">
      <span class="AVSrch" id="AVSrch"> <br>
...
Web </span>
  ...
  <tr>
    <td height="40" valign="top" bgcolor="#FFCC00">
      <form name="formSearch" method="post" action="#" target="_self">
    </form></td>
    <td rowspan="3" valign="top" bgcolor="#FFCC00"  > <p><img src="images/AFRICA_MAP.gif" width="440" height="440" border="0" usemap="#Map"   id="AVMap" class="AVMapShow"  >
      <map name="Map">
        ...
        <area shape="poly" coords="75,75,144,125,170,106,186,99,184,93,173,84,174,76,173,59,162,37,168,24,154,22,137,23,126,26,115,32,116,49,102,51,90,61,78,67" href="#" onClick="MM_callJS('Algeria')">
  ...
  <td bgcolor="#FFCC00"><span class="ShowMe"><a href="#" 
    onClick="MM_showHideLayers('AVMap','','hide');MM_showHideLayers('AVMapH','','hide');MM_showHideLayers('AVMapS','','show')"  id="AVMapH">Hide Map >></a> <a href="#"    onClick="MM_showHideLayers('AVMap','','show');MM_showHideLayers('AVMapH','','show');MM_showHideLayers('AVMapS','','hide')" id="AVMapS"><&lt;Show Map</a></span></td>
  </tr>
  <tr>
    <td rowspan="2" valign="top"  >
      <div class="AVbodyText" id="AVbodyV"   >
        <p>We are working under a simple premise  to answer these questions:</p>
        <ol>
        ...
        <p>These five basic questions seek  answers to roles being played by others like you, in preparation for future  leadership Africa vision 2020. It is important therefore to think through these  questions as you browse through this web site. If you can answer one  confidently, we urge you to explore the option to become a <a href="index.php">member</a> of Vision 2020 board. <br>
          Today others engaged in pursuing  practical goals which may shape the future for generations to come. Again what  is your role? As member of project 2020 across the continent you get guidance  to a point of contact in Kenya, Ghana, and South Africa or any places in land  where you can choose from thousands of Vision 2020 projects such as: </p>
        <ul type="disc">
        ...
        <p class="AVbodyText">&nbsp;</p>
        <p class="AVbodyText"><br>
        </p>
    </div></td>
    <td valign="top"><div id="formAVLogin"  class="AVForms">
        <form action="webauth.php" method="post" name="formUserAuth" class="AVMenu" id="LoginForm"  >
          <table>
            <tr>
              <td class="AVForms2"> Username:</td>
              <td><input type="text" name="uname" id="uname2"></td>
            </tr>
            <tr>
              <td class="AVForms2">Password:</td>
              <td><input type="password" name="pname" id="pname2"></td>
            </tr>
          </table>
          <div align="center"><a href="#" onClick="return checkform();">Login</a> | <a href="#" onClick="MM_showHideLayers('formAVJoinUs','','show');getMainContentStatus('newuser');clearForm(document.formjoinAVNet);clearForm(document.formUserAuth)"> Create account</a></div>
        </form>
