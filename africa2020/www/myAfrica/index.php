...
<body  class="AVBody" onLoad="MM_showHideLayers('AVMapS','','hide')">

<table width="913" border="0" align="center" >
  <tr>
    <td width="232" height="23" class="AVMenu"  >
      <p><a href="index.php" target="_self" id="home">Home</a> |
        <a href="#" id="aboutus">About us</a> | 
        <a href="#" id="v2020" onClick="MM_showHideLayers('LoginForm','','show')">Login</a>  
       <br>
      </td>
    <td width="440" valign="top"><div align="center"><span class="AVHeaders"> Africa Vision 2020 </span></div></td>
    <td width="227"><span class="AVHiLights">Date:      
    ...
    <td height="40">
      <form name="formSearch" method="post" action="search.php" target="_self">
        ...
        <p>
          ...
          <input type="text" name="txtSearch" id="mySearch" onChange="return SearchNow(document.formSearch.txtSearch.value)"  onClick="MM_showHideLayers('AVSrch','','show')">
          <br> 
...
Web </span></p>
    ...
    <td width="227" class="ShowMe"><a href="#" 
    onClick="MM_showHideLayers('AVMap','','hide');MM_showHideLayers('AVMapH','','hide');MM_showHideLayers('AVMapS','','show')"  id="AVMapH">Hide Map >></a> <a href="#"    onClick="MM_showHideLayers('AVMap','','show');MM_showHideLayers('AVMapH','','show');MM_showHideLayers('AVMapS','','hide')" id="AVMapS"><&lt;Show Map</a></td>
  </tr>
  <tr>
    <td rowspan="2" valign="top"  >     

      <div id="AVbodyV" class="AVbodyText"   >
      <span class="style6">Our focus as group is to promote trade, Technology assembly  plans, mineral exploration and massive Agricultural infrastructure planning. In  the continent we are committed to work with the various governments within the  continent, other organizations and the local communities to bring simple idea  on planning for tomorrow with the standards the continent deserves. We are  constantly working with other international governments  such as United  States, Europe nations, China, Russian, Japan and the Middle Eastern countries  to embrace current changes taking place across the continent of Africa.&nbsp; Currently we are engaged in pursuing practical goals in  areas such as: </span>
      <ul>
        <li class="style6">Commodity Trading</li>
        <li class="style6">Technology Resources</li>
        <li class="style6">Minerals &nbsp;and Exploration Resources</li>
        <li class="style6">Import and Export Resources</li>
        <li class="style6">Shipping, and Freight clearance</li>
        </ul>   
      <p><span class="style6">We hope you enjoy our services. <br>
For questions, comments or any concerns send us a note at <a href="mailto:support@dwere.net?subject='Support Africa Vision 2020'">Support</a></span>. </p>
      </div>       </td>
    <td rowspan="2"  valign="top">
    
    <img src="images/AFRICA_MAP.gif" width="440" height="440" border="0" usemap="#Map"   id="AVMap" class="AVMapShow"  >
      <map name="Map">
    ...
    <td valign="top"><div id="formAVLogin"  class="AVForms">
    <form action="" method="post" name="LoginForm" class="AVMenu" id="LoginForm">
    <table><tr><td> Username:</td><td><input type="text" name="username" id="username"></td></tr>
     <tr><td>Password:</td><td><input type="password" name="userpass" id="userpass"></td></tr>
     
     </table>
       <a href="#" onClick="javascript:document.formjoinAVNet.submit()">Login</a> | <a href="#" onClick="MM_showHideLayers('LoginForm','','hide')">Cancel </a> | <a href="#" onClick="MM_showHideLayers('formAVJoinUs','','show');"> Create account</a>
    </form>   </div><div id="formAVJoinUs"  class="AVForms">
      <form action="joinavcom.php" method="POST" enctype="multipart/form-data" name="formjoinAVNet" target="_self">
        
              Full Name:<br>
          <input name="name" type="text" id="myname" size="32">              
          <br> 
              Email Address:  
              <input name="email" type="text" id="myemail" size="32">
              <br>Username:<br>
                ...
                <br>  
                Password Verify:<br>
                <input type="passverify" name="password" id="passverify"  size="32"> 

      <input name="knownstates" type="hidden" id="knownStates">
              <br> 
              Country: <br> 
          <input name="country" type="text" id="mystate" size="32" >
          <div align="left">
            <font id="AVMsg"><span class="style3">&lt;&lt;= Select your country from the map or type  
            in the country box above.</span></font><font  color="#FF0000">
            </font><br>
           
            <p><a href="#" onClick="javascript:document.formjoinAVNet.submit()">Continue</a> | <a href="#" onClick="MM_showHideLayers('formAVJoinUs','','hide')">Cancel</a> <p> <span class="style6">After your email has been verified, you will be guided to create a unique screen name and a password.<br>
            </span></div>
              </p>
      </form>
      <hr>
  ...
  <tr>
    <td colspan="3"><p align="center"><span class="AVForms">Copyright &copy; 1999 &mdash; 2008 Africa Vision 2020. All   rights reserved. <br>
All logos and trademarks are properties of their respective   companies. Product price, specification, warranty and availability subject to   change without notice.</span></p>
    <p align="center">&nbsp;</p></td>
  </tr>
</table>
