...
<body  onload = "getText('AVbodyV',document.formSearch.txtSearch.value);"> <!-- document.AVFormContent.file.value='community'getText('AVCenterStage','avmap.txt') -->
<table width="932" border="0" align="center" cellpadding="2" cellspacing="0">
  <tr bgcolor="#FFCC00" >
    <td height="10" colspan="2" class="AVMenu"><!--| <a href="#" target="_self" onClick="getText('AVbodyV',document.AVFormContent.file.value='home')">Home</a> <a href="#" onClick="getText('AVbodyV',document.AVFormContent.file.value='about')">About us</a> //-->      <a href="#" target="_self" onClick="getText('AVbodyV',document.AVFormContent.file.value='community')">My Community</a> | <a href="#" onClick="getText('AVbodyV',document.AVFormContent.file.value='trading')">Trading: $1</a><br></td>
    <td width="498"><div align="center"><span class="AVHeaders">Africa Vision 2020 </span></div></td>
    <td width="204" rowspan="2" bgcolor="#000000" class="AVMenu style18">There are <font color="#FF0000">
      <?=$UsersOnLine?>
 ...
 ?></td>
  ...
  <tr bgcolor="#FFCC00">
    <td width="165" height="21" class="AVMenu"><a href="#"  onClick="getProfileText('<?=$challenge?>')">You are:
          <?=$myname?>
    </a></td>
    <td width="49" class="AVMenu"><div align="center"><a href="logout.php" target="_self"  onClick="logout()">Log out</a></div></td>
    <td width="498" rowspan="2" valign="top" bgcolor="#FFCC00" class="ShowMe"> <div align="left"><strong><img src="images/mpoll.gif" alt="My Picture" name="mypicture" width="10" height="50" hspace="2" vspace="0" border="0" align="left"><span class="AVbodyText style19">Welcome!</span> <span class="AVbodyText"><strong>My  place for Real-Time Resources. Know all about =&gt; | Trade | Tourism | Development | Healthe Care | Technology Exploration | Minerals | Food | Agriculture | Micro Loan Financing | Infrastructure planning |</strong> <span class="style19"><em><a href="#">eAfrica</a></em> </span></span></strong> </div></td>
  </tr>
  <tr valign="top">
    <td height="20" colspan="2" bgcolor="#FFCC00">
      <form name="formSearch" method="post" action="#" target="_self" onClick="getText('AVbodyV',document.formSearch.txtSearch.value);">
        <input name="button" type="submit" class="AVMenu" id="button2"   value="Search" >
        <input type="text" name="txtSearch" id="txtSearch2" value="<?=$mystate?>"  onChange="getText('AVbodyV',document.formSearch.txtSearch.value);"
               
              onclick="MM_showHideLayers('AVSrch','','show');getCountryText('avnetwork')">
        <br>
    ...
    <td width="204" bgcolor="#FF0000" ><p align="center">RSS and Technology Support</p></td>
  </tr>
  <tr valign="top">
    <td height="42" colspan="2" bgcolor="#7CC4FC">
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="8927966">
<table>
<tr><td><input type="hidden" name="on0" value="iCard Phone Card">iCard Phone Card</td></tr><tr><td><select name="os0">
	<option value="Card">Card $5.00
	<option value="Card">Card $10.00
	<option value="Card">Card $20.00
</select> </td></tr>
</table>
<input type="hidden" name="currency_code" value="USD">
<input type="image" src="https://www.paypal.com/en_US/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
<img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
</form>    </td> <td rowspan="2" background="#FFCC00" bgcolor="#7CC4FC" >  <span class="style11 AVbodyText" id="AVCenterStage" ><img src="images/AFRICA_MAP.gif" width="440" height="440" border="0" usemap="#Map"   id="AVMap" class="AVMapShow"  >
      <map name="Map">
        ...
        <area shape="poly" coords="99,200,91,202,83,202,79,204,75,205,75,199,70,195,70,189,72,180,72,175,75,171,85,172,87,174,94,175,100,175,101,181,101,189,99,197" href="#" onClick="MM_callJS('Côte d\'ivoire')">
...
<td width="204" align="center" valign="top" bgcolor="#00CC00" >    
<div align="left"><span class="AVMenu"><a href="#" 
    onClick="getText('AVCenterStage','notes.php')"  id="AVMapH">Make Notes </a>
     | <a href="#"    onClick="MM_showHideLayers('AVMap','','show');MM_showHideLayers('AVMapH','','show');" id="AVMapS"> Show Map</a></span></div>
   <div align="left"  class="AVMenu" id="AVFormMember"> <span class="style19">Member since [<span class="style28">2009</span>]<br>
   Status:</span> <span class="style20"><span class="style28">Silver</span></span> <br>
   <span class="AVForms">[<a href="#" onClick="getText('AVCenterStage','donate.txt')">Re-New</a>]</span></div></td>
  </tr>
  <tr>
  
    <td height="400" colspan="2" valign="top"  bgcolor="#FFCC00">
    ...
    <td valign="top" bgcolor="#3399FF" class="AVForms"> 
       <span class="style20">What New?       </span>
      <ul>
        <li><a href="http://www.dvlottery.state.gov" target="_blank">US Visa Lottery 2011</a> </li>
      ...
      <p>&nbsp;</p>      <div align="center">
        ...
        <p>
        <div align="center"  class="style11">Was this web site helpful you? </div>
        <hr>
...
value="1" onClick="getVote(this.value)">
  ...
  <tr>
    <td colspan="2" valign="top"  bgcolor="#FFCC00">&nbsp;</td>
    <td width="498" valign="top" bgcolor="#7CC4FC" class="AVbodyText"><p class="AVbodyText style19">Today  others engaged in pursuing practical goals which may shape the future for generations to come. Again what is your role? As member  of project 2020 accross the continent you get guidience to a point of contact in Kenya, Ghana, South Africa or any places in land where you can choose from thousands of Vision 2020 projects such as: </p>
      <ul class="style12">
        <li class="AVbodyText style19">Healthcare planning</li>
        <li class="AVbodyText style19"> Shipping, and Freight clearance.</li>
        <li class="AVbodyText style19">Commodity Trading.</li>
        <li class="AVbodyText style19">Technology Trading and Recycling.</li>
        <li class="AVbodyText style19">Minerals and Exploration Resources.</li>
        <li class="AVbodyText style19">Import and Export Resources.</li>
        <li class="AVbodyText style19">Development projects.</li>
      </ul>
    <p class="AVbodyText"></p></td>
    <td valign="top" bgcolor="#FFCC00" class="AVForms"> <span class="style8">If you like a copy of this <u><strong>Web Site Rating Script</strong></u> Please use the donation $3 to our program and we will send you a copy with instructions to download or mail you a CD. Thank you!</span>
      <p>
      <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
        <input type="hidden" name="cmd" value="_s-xclick">
  ...
  <tr>
    <td colspan="2" valign="top"  bgcolor="#FFCC00">&nbsp;</td>
    <td width="498" valign="top" bgcolor="#FFCC00" class="AVbodyText style19"><div align="center" class="AVInfo"> <a href="#">Technology</a> | <a href="#">Facebook</a> | <a href="#">AllAfrica</a> | <a href="#">News</a> | <a href="#">Scholarship</a> | <a href="#">USCIS</a> |<a href="#"> US Embassy</a> </div></td>
    <td valign="top" bgcolor="#FFCC00" class="AVForms">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2" bgcolor="#FFCC00"><script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','218','height','32','src','ilinks','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','ilinks' ); //end AC code
</script><noscript><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="218" height="32">
      <param name="movie" value="ilinks">
      <param name="quality" value="high">
      <embed src="ilinks" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="218" height="32"></embed>
    </object></noscript></td>
    <td width="498" valign="top" bgcolor="#FFCC00" class="AVbodyText">&nbsp;</td>
