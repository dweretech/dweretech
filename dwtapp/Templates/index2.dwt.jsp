...
<div class="container">
  <div class="header"><a href="#"><img src="/images/dwt-logo.gif" alt="Insert Logo Here" name="Insert_logo" width="71" height="79" id="Insert_logo" style="background: #8090AB; display:block;" /></a> 
    <!-- end .header --></div>
  <div class="sidebar1">
    <ul class="nav">
  ...
  <div class="content">
    ...
    <h1>Inspired Technology</h1>
    <p>We do have lifelong growth in developing technology resource capacity and quality to partner with technology innovator. From the recruitment and training of our professionals to tracking performance for every client assignment, we are focus to build a business relationship with you. </a>.</p>
