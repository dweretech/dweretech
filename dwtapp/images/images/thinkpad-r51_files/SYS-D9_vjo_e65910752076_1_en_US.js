...
vjo.ctype("vjo.darwin.core.rtm.RTMInit").needs(["vjo.dsf.utils.URL","vjo.darwin.core.rtm.RTMHelper","vjo.dsf.assembly.VjClientAssembler"]).satisfies("vjo.dsf.common.IJsServiceHandler").protos({oRTM:null,constructs:function(_1){this.oRTM=new vjo.darwin.core.rtm.RTM(_1);vjo.darwin.core.rtm.RTMHelper.setRtm(this.oRTM);},invoke:function(_2){var t=this;var _4=t.oRTM.processGlobalNavPids(true);var _5=t.oRTM.processGlobalNavPids(false);if(_4!==""){var U=vjo.dsf.utils.URL;var _7=t.oRTM.oJSBean.url;_7=U.addArg(_7,"e","USC:"+t.oRTM.getSegment(false));var p=U.getArg(_7,"p");var ph=U.getArg(_7,"ph");var ev=U.getArg(_7,"ev");if((p!==null)&&!p.has(_4)){t.oRTM.oJSBean.url=_7.replace("p="+p,"p="+p+":"+_4);if(ph!=null){t.oRTM.oJSBean.url=t.oRTM.oJSBean.url.replace("ph="+ph,"ph="+ph+":"+_5);}
if(ev!=null){t.oRTM.oJSBean.url=t.oRTM.oJSBean.url.replace("ev="+ev,"ev="+ev+":"+_5);}}
...
vjo.dsf.EventDispatcher.addEventListener(window,"load",t.oRTM.setTimeOut,t.oRTM);_2.returnData=false;},onLoad:function(){var t=this;window.setTimeout(function(){t.onSend();},0);},onSend:function(){var _c=this.oRTM,opt=_c.bOptimize,func=opt?_c.storeResponse:_c.setInlineContent;var _d=new vjo.dsf.assembly.VjClientAssemblerRequest(_c.oJSBean.url,func,_c,"cb",!opt);vjo.dsf.assembly.VjClientAssembler.load(_d);}}).endType();
...
vjo.ctype("vjo.darwin.core.rtm.RTM").needs(["vjo.dsf.cookie.VjCookieJar","vjo.dsf.client.Browser","vjo.dsf.client.ActiveX","vjo.dsf.EventDispatcher","vjo.dsf.flash.Version","vjo.dsf.utils.JsLoader","vjo.dsf.utils.CssLoader","vjo.Registry"]).protos({oJSBean:null,aContent:[],iContentLen:0,bTimedOut:false,oTimeoutId:null,iTIMEOUT:300,oClient:null,bResponseReturned:false,iOrd:0,aGlbNavPlac:null,promos:null,globalAdOverlay:null,response:null,renderedStatus:null,bodyLoadedTime:0,renderCSS:false,bPromoScript:false,bPromoStyle:false,bOptimize:false,debug:false,hasExp:false,E:vjo.dsf.document.Element,constructs:function(_1){var t=this;this.oJSBean=_1||{};t.oJSBean.quickPids=t.oJSBean.quickPids||[];t.aContent=[];t.iContentLen=0;t.bTimedOut=false;t.oTimeoutId=null;t.iTIMEOUT=3000;t.oClient=vjo.dsf.client.Browser;t.bResponseReturned=false;t.iOrd=(new Date()).getTime();t.aGlbNavPlac=null;t.promos=new Object();t.globalAdOverlay=null;vjo.Registry.put("GlobalRtmInstance",t);t.response=null;t.renderedStatus={};t.bodyLoadedTime=-1;t.renderCSS=false;t.aEvCon=[];t.bOptimize=true;t.debug=false;t.hasExp=false;if(t.bOptimize){vjo.dsf.EventDispatcher.add("body","load",t.render,t);}
vjo.dsf.ServiceEngine.registerSvcReqtHdl("RTM_LOAD_PIDS",t);},handleRequest:function(_3){var m=_3;for(var i=0;i<m.pids.length;i++){var _6=this.getIndex(m.pids[i]);this.processPromo(this.aContent[_6]);}},getFlashVersion:function(){return this.vj$.Version.get();},getEncodingType:function(){return"UTF-8";},setInlineContent:function(_7){var t=this;if(t.TimedOut()){return;}
t.hidePromos(t.promos);t.aContent=_7;t.iContentLen=t.aContent.length;var _9=false;t.bPromoScript=false;t.bPromoStyle=false;if(!t.renderCSS){for(var j=0;j<t.iContentLen;j++){var _b=t.aContent[j];if(_b.CSSMetaData){t.renderCSS=true;t.processCSS(_b.CSSMetaData);}}}
for(var i=0;i<t.iContentLen;i++){var _b=t.aContent[i];if(_b.expand){t.hasExp=true;}
if(_b.JSMetaData){t.processJS(_b.JSMetaData);}else{if(!_b.CSSMetaData){if(t.oJSBean.triggerEvent&&t.oJSBean.triggerEvent[i]==1){t.aEvCon[i]=_b.content;}else{t.processPromo(_b);}}}}
t.initExpandables();var _d=new vjo.dsf.Message("RTM_COMPLETE");_d.status=1;_d.vjRTMObject=t;vjo.dsf.ServiceEngine.handleRequest(_d);if(_9){_d=new vjo.dsf.Message("PROMO_COMPLETE");_d.vjPromoClientObject=t;vjo.dsf.ServiceEngine.handleRequest(_d);}},TimedOut:function(){this.bResponseReturned=true;if(this.bTimedOut){return true;}
...
_4a.innerHTML=pAd.content;_4a.style.display="block";var id=pAd.id;if(id==184||id==188||id==218||id==569||id==570){t.executeScript(id);}}else{t.addStatus(_49,false);}},executeScript:function(id){var _4e="rtm_html_"+id,E=this.E;var _4f=E.get(_4e).getElementsByTagName("script")[0];if(_4f!=null){var s=document.createElement("script");s.type="text/javascript";if(_4f.text){s.text=_4f.text;}else{s.textContent=_4f.textContent;}
E.get(_4e).appendChild(s);}},processHTMLFormAd:function(pAd){var t=this;if(pAd.height=="-1"||pAd.height=="9999"){pAd.height="auto";}
if(pAd.width=="-1"||pAd.width=="9999"){pAd.width="auto";}
var _53=t.getIndex(pAd.id);var _54=t.oJSBean.htmlIds[_53];var _55=t.getUIElement(_54);if(t.getStatus(_54)){return;}
if(_55&&!_55.length){t.addStatus(_54,true);var _56=_55.style,h,w;_56.height=h=(pAd.height.has("auto"))?pAd.height:pAd.height+"px";_56.width=w=(pAd.width.has("auto"))?pAd.width:pAd.width+"px";if(h!="auto"&&w!="auto"){_56.overflow="hidden";}
var f=document.createElement("iframe");f.setAttribute("hspace",0);f.setAttribute("vspace",0);f.setAttribute("width","100%");f.setAttribute("frameBorder",0);f.setAttribute("scrolling","no");f.setAttribute("marginWidth",0);f.setAttribute("marginHeight",0);_55.appendChild(f);f.doc=null;if(f.contentDocument){f.doc=f.contentDocument;}else{if(f.contentWindow){f.doc=f.contentWindow.document;}else{if(f.document){f.doc=f.document;}}}
if(f.doc==null){throw"RTM002";}
f.doc.open();try{f.doc.write(pAd.content);}
finally{f.doc.close();}}else{t.addStatus(t.oJSBean.htmlIds[_53],false);}},getUIElement:function(_58){var s=_58,d=window.document;if(d.getElementById){return d.getElementById(s);}else{if(d.all){return d.all(s);}}
return null;},getIndex:function(pId){for(var i=0;i<this.iContentLen;i++){if(this.aContent[i].id==pId){return i;}}},createIframe:function(pId,_5d,_5e,_5f){var _60="ifrm_"+pId;var f="<iframe frameborder=\"no\" border=\"0\" marginwidth=\"0\" marginheight=\"0\" scrolling=\"no\""+" id=\""+_60+"\""+" name=\""+_60+"\""+" src=\""+_5d+"\""+" width=\""+_5f+"\" height=\""+_5e+"\"></iframe>";return f;},appendUrl:function(_62){this.oJSBean.url+=_62;},processGlobalNavPids:function(_63){var t=this,sParams="",oGlobalNav;if(typeof(_oGlobalNavRTMInfo)!="undefined"){oGlobalNav=_oGlobalNavRTMInfo;t.aGlbNavPlac=oGlobalNav.aRTMPlacementData;}
if(oGlobalNav&&t.aGlbNavPlac&&t.aGlbNavPlac.length>0){var _65=_oGlobalNavRTMInfo.aRTMPlacementData,data;for(i=0;i<_65.length;i++){if(_63){data=_65[i];}
if(sParams){sParams+=":";}
sParams+=_63?data.pid:"0";}}
...
var len=t.aGlbNavPlac.length;for(var i=0;i<len;i++){var _69=b.htmlIds.length;var p=t.aGlbNavPlac[i];b.htmlIds[_69]=(p.htmlId)?p.htmlId:"glbl_nav_no_html_id";b.pids[_69]=(p.pid)?p.pid:"glbl_nav_no_pid";b.heights[_69]=(p.maxHeight)?p.maxHeight:"glbl_nav_no_height";b.widths[_69]=(p.maxWidth)?p.maxWidth:"glbl_nav_no_width";b.dblclkUrls[_69]=(p.dblclkUrl)?p.dblclkUrl:"glbl_nav_no_dblclk";b.defaultUrls[_69]=(p.defaultUrl)?p.defaultUrl:"collapse";if(p.renderBeforeOnload&&b.quickPids){b.quickPids[b.quickPids.length]=p.pid;}}},setTimeOut:function(){if(!this.bResponseReturned){var _6b=this;var _6c=function(){_6b.processTimeOut();};this.oTimeoutId=window.setTimeout(_6c,this.iTIMEOUT);}},processTimeOut:function(){var t=this;t.bTimedOut=true;var _6e=t.oJSBean;var _6f=_6e.defaultUrls.length;for(var i=0;i<_6f;i++){var id=_6e.htmlIds[i];var _72=t.getUIElement(id);var _73=_6e.defaultUrls[i];if(t.getStatus(id)){continue;}
if(_72&&!_72.length){t.addStatus(id,true);if(!_73||_73=="collapse"||_73==""){_72.style.height="0px";_72.style.display="none";}else{_72.innerHTML=t.createIframe(id,_73,_6e.heights[i],_6e.widths[i]);}}else{t.addStatus(id,false);}}
var _74=Math.random();if(_74<0.05){var u=_6e.url;var _76=u.indexOf("&");u=u.substring(0,_76);u=u+"&p="+_6e.pids.join(":")+"&ite=2&to="+t.iTIMEOUT;u=u.replace("RtmCmd","RtmIt");var _77=document.createElement("script");_77.type="text/javascript";_77.src=u;document.getElementsByTagName("head")[0].appendChild(_77);}
window.clearTimeout(t.oTimeoutId);var _78=new vjo.dsf.Message("RTM_COMPLETE");_78.status=0;_78.vjRTMObject=t;vjo.dsf.ServiceEngine.handleRequest(_78);},getBrowserWidth:function(){var b=this.oClient;var _7a=document.body.clientWidth;if(!b.bIE){_7a=window.innerWidth;}
return _7a;},popUp:function(_7b,_7c,_7d,_7e,_7f,_80,_81,_82,_83,_84,_85,_86){var s="";s+=(_7d!=null)?",width="+_7d:"";s+=(_7e!=null)?",height="+_7e:"";s+=(_82!=null)?",screenX="+_82+",left="+_82:"";s+=(_83!=null)?",screenY="+_83+",top="+_83:"";s+=",toolbar="+((_80)?"1":"0");s+=",location="+((_84)?"1":"0");s+=",status="+((_7f)?"1":"0");s+=",scrollbars="+((_81)?"1":"0");s+=",resizable="+((_85)?"1":"0");s+=",menubar="+((_86)?"1":"0");if(s.length>0){s=s.substring(1);}
window.open(_7c,_7b,s);return false;},getSegment:function(_88){var oCJ=vjo.dsf.cookie.VjCookieJar,e=oCJ.readCookie("etfc"),r=oCJ.readCookie("reg"),s=oCJ.readCookie("ebay","sin"),c,n;if(e=="0"){n="3";c="E";}else{if(e=="1"){n="4";c="C";}else{if(e=="2"){n="5";c="D";}else{if((e==""&&(r!=""&&r!=";"))||s=="in"||e=="5"){n="2";c="B";}else{n="1";c="A";}}}}
return _88?c:n;},getCIDCookie:function(){var oCJ=vjo.dsf.cookie.VjCookieJar;var cid=oCJ.readCookie("npii","cguid");if(cid!="undefined"&&cid!=""){return cid;}},openReportAd:function(_8c,_8d,_8e,_8f,_90,_91,_92,_93,_94,_95,_96){if(this.globalAdOverlay==null){this.globalAdOverlay=new vjo.darwin.core.rtm.ReportAd(_8e,_8f,_90,_91,_94,_95,_8d,_96);}
if(this.globalAdOverlay!=null){this.globalAdOverlay.init(_92,_93);this.globalAdOverlay.open(_8c);}},closeReportAd:function(){if(this.globalAdOverlay!=null){if(this.globalAdOverlay){this.globalAdOverlay.close();}}},submitReportAd:function(){if(this.globalAdOverlay!=null){if(this.globalAdOverlay){this.globalAdOverlay.submitReport();}}},yahooAdBckGrnd:function(_97){var f=this.E.get(_97);f.style.visibility="visible";f.parentNode.style.backgroundColor="transparent";},addStatus:function(_99,_9a){this.renderedStatus[_99]=_9a;},getStatus:function(_9b){return this.renderedStatus[_9b];},storeResponse:function(_9c){var t=this,c=_9c,qp;t.response=c;t.aContent=c;t.iContentLen=c.length;if(t.bodyLoadedTime>-1){t.setInlineContent(c);}else{if(!this.TimedOut()){qp=t.oJSBean.quickPids;if(qp&&qp.length>0){t.renderPromos(qp);}}}
if(_9c!=null){for(var i=0;i<_9c.length;i++){if(_9c[i]!=null&&_9c[i].content!=null&&_9c[i].content.indexOf("openReportAd")>0){this.addReportAdScript();break;}}
if(!t.renderCSS){for(var j=0;j<_9c.length;j++){var _a0=_9c[j];if(_a0.CSSMetaData){t.renderCSS=true;t.processCSS(_a0.CSSMetaData);}}}}
if(_9c!=null&&_9c.indexOf("openReportAd")>0){this.addReportAdScript();}},addReportAdScript:function(){try{if(this.oJSBean.reportAdJsUrl){var _a1=document.createElement("script");_a1.type="text/javascript";_a1.src=this.oJSBean.reportAdJsUrl;document.getElementsByTagName("head")[0].appendChild(_a1);}}
...
catch(e){}}}).props({siteCatalyst:function(_ef,_f0,PID,_f2){var esc=vjo.darwin.tracking.sitecatalyst;if(esc){var _f4="Search",loc="North";if(PID==188||PID==570){_f4="Browse";}
if(PID==569||PID==570){loc="Sky";}
var s=esc.EbaySiteCatalyst.s;s.linkTrackVars="prop27";s.linkTrackEvents="None";s.prop27=_f0+":"+_f4+":"+PID+":"+_f2;if(_ef){s.linkTrackVars="prop28";s.prop28=s.prop27;s.prop27=null;}
...
// en_US/e659/SYS-D9_vjo_e65910752076_1_en_US
// b=10752076