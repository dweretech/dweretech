...
function swapImage(imgIdx) {
        theImages = new Array(["dwt-info.JPG","Doing Business with DWERE!","http://dwere.net"],
							  ...
							  ["logoEbay_x45.gif","Visit our deal store on eBay","http://www.ebay.com/itm/260938818015"],
...
'" alt="" width="174" height="174" align="right"> </a>'+theImages[whichImage][1]+'</center>';
}
else {
